...
- `/visao` — Define your product, break it into sections, and sketch the data shape — all in one flow
- `/estilo` — Choose your color palette and typography
- `/estrutura` — Design navigation and layout
- `/secao` — Define a section's scope, requirements, and generate sample data + types
- `/tela` — Create production-ready React components
- `/foto` — Snap a screenshot of a finished design screen for quick reference
- `/exportar` — Generate the complete handoff package
- `/roadmap` — Update your product sections (after initial creation)
- `/dados` — Update your data entities (after initial creation)
