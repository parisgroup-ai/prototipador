...
- A product overview (`/visao`)
- A roadmap with sections (`/roadmap`)
...
- [ ] Product entities — Run `/dados` for consistent entity naming
- [ ] Design tokens — Run `/estilo` for consistent styling
- [ ] Application shell — Run `/estrutura` for navigation structure
...
- Remove any Prototipador-specific imports
...
- Remove Prototipador-specific imports
...
- The export is self-contained — no dependencies on Prototipador
